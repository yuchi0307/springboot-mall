...
import com.yuchi.springbootmall.rowmapper.OrderItemRowMapper;
import com.yuchi.springbootmall.rowmapper.OrderRowMapper;
import com.yuchi.springbootmall.service.impl.OrderServiceImpl;
...
public class OrderDaoImpl implements OrderDao {
    ...
    public List<OrderItem> getOrderItemsByOrderId(Integer orderId) {
        ...
        Map<String, Object> map = new HashMap<>();
        map.put("orderId", orderId);
        log.warn("Dao getOrderItemsByOrderId orderId的值: {} ", orderId);
